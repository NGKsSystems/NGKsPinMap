...
class PinMapApp {
    ...
    addMarker(pin) {
        ...
        marker.bindPopup(`
            <div class="pin-popup">
                ...
                ${pin.phone ? `Phone: <span class="phone-hidden" id="phone-${pin.id}">••••••••</span> <button class="phone-toggle-btn" id="phone-toggle-${pin.id}" data-phone="${pin.phone}">Show</button><br>` : ''}
            ...
            setTimeout(() => {
                ...
                if (phoneToggleBtn && phoneDisplay) {
                    phoneToggleBtn.onclick = () => {
                        if (phoneDisplay.classList.contains('phone-hidden')) {
                            phoneDisplay.textContent = phoneToggleBtn.dataset.phone;
    ...
    editPin(pin) {
        ...
        document.getElementById('phone').value = pin.phone || '';
