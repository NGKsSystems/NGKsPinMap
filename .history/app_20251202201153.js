...
// Comprehensive world cities database (200+ cities with coordinates)
const WORLD_CITIES_DATABASE = {
    'Paris': [48.8566, 2.3522], 'London': [51.5074, -0.1278], 'Berlin': [52.5200, 13.4050], 'Madrid': [40.4168, -3.7038],
    'Rome': [41.9028, 12.4964], 'Amsterdam': [52.3676, 4.9041], 'Barcelona': [41.3851, 2.1734], 'Vienna': [48.2082, 16.3738],
    'Prague': [50.0755, 14.4378], 'Warsaw': [52.2297, 21.0122], 'Athens': [37.9838, 23.7275], 'Istanbul': [41.0082, 28.9784],
    'Budapest': [47.4979, 19.0402], 'Bucharest': [44.4268, 26.1025], 'Sofia': [42.6977, 23.3219], 'Belgrade': [44.8176, 20.4568],
    'Zagreb': [45.8150, 15.9819], 'Lisbon': [38.7223, -9.1393], 'Dublin': [53.3498, -6.2603], 'Brussels': [50.8503, 4.3517],
    'Zurich': [47.3769, 8.5472], 'Geneva': [46.2044, 6.1432], 'Milan': [45.4642, 9.1900], 'Venice': [45.4408, 12.3155],
    'Florence': [43.7696, 11.2558], 'Munich': [48.1351, 11.5820], 'Stockholm': [59.3293, 18.0686], 'Oslo': [59.9139, 10.7522],
    'Copenhagen': [55.6761, 12.5683], 'Helsinki': [60.1695, 24.9354], 'Dubai': [25.2048, 55.2708], 'Abu Dhabi': [24.4539, 54.3773],
    'Kuwait': [29.3759, 47.9774], 'Abu Halifa': [29.3667, 47.9667], 'Doha': [25.2854, 51.5310], 'Riyadh': [24.7136, 46.6753],
    'Jeddah': [21.5433, 39.1727], 'Beirut': [33.8886, 35.4955], 'Damascus': [33.5130, 36.2765], 'Baghdad': [33.3128, 44.3615],
    'Tehran': [35.6892, 51.3890], 'Cairo': [30.0444, 31.2357], 'Alexandria': [31.2001, 29.9187], 'Jerusalem': [31.7683, 35.2137],
    'Tel Aviv': [32.0853, 34.7818], 'Amman': [31.9454, 35.9284], 'Tokyo': [35.6762, 139.6503], 'Osaka': [34.6937, 135.5023],
    'Bangkok': [13.7563, 100.5018], 'Singapore': [1.3521, 103.8198], 'Hong Kong': [22.3193, 114.1694], 'Shanghai': [31.2304, 121.4737],
    'Beijing': [39.9042, 116.4074], 'Mumbai': [19.0760, 72.8777], 'Delhi': [28.7041, 77.1025], 'Bangalore': [12.9716, 77.5946],
    'Kolkata': [22.5726, 88.3639], 'Lahore': [31.5204, 74.3587], 'Karachi': [24.8607, 67.0011], 'Islamabad': [33.6844, 73.0479],
    'Manila': [14.5995, 120.9842], 'Cebu': [10.3157, 123.8854], 'Ho Chi Minh City': [10.7769, 106.7009], 'Hanoi': [21.0285, 105.8542],
    'Jakarta': [6.2088, 106.8456], 'Surabaya': [-7.2575, 112.7521], 'Kuala Lumpur': [3.1390, 101.6869], 'Seoul': [37.5665, 126.9780],
    'Busan': [35.1796, 129.0756], 'Incheon': [37.4563, 126.7052], 'Moscow': [55.7558, 37.6173], 'Johannesburg': [-26.1923, 28.0436],
    'Cape Town': [-33.9249, 18.4241], 'Lagos': [6.5244, 3.3792], 'Accra': [5.5595, -0.2067], 'Nairobi': [-1.2865, 36.8172],
    'Casablanca': [33.5731, -7.5898], 'Marrakech': [31.6295, -8.0088], 'Mexico City': [19.4326, -99.1332], 'Toronto': [43.6532, -79.3832],
    'Vancouver': [49.2827, -123.1207], 'São Paulo': [-23.5505, -46.6333], 'Rio de Janeiro': [-22.9068, -43.1729], 'Buenos Aires': [-34.6037, -58.3816],
    'Lima': [-12.0464, -77.0428], 'Bogotá': [4.7110, -74.0721], 'Cartagena': [10.3932, -75.4830], 'Monterrey': [25.6866, -100.3161],
    'Sydney': [-33.8688, 151.2093], 'Melbourne': [-37.8136, 144.9631], 'Brisbane': [-27.4698, 153.0251], 'Auckland': [-37.0082, 174.7850],
    'Wellington': [-41.2865, 174.7762], 'Christchurch': [-43.5321, 172.6362], 'Bangkok': [13.7563, 100.5018], 'Phuket': [8.0863, 98.3384],
    'Chiang Mai': [18.7883, 98.9853], 'Dubai': [25.2048, 55.2708], 'Abu Dhabi': [24.4539, 54.3773], 'Sharjah': [25.3571, 55.3986],
    'Ras Al Khaimah': [25.7482, 55.9754], 'Fujairah': [25.1242, 56.3528], 'Ajman': [25.4017, 55.4515], 'Umm Al Quwain': [25.5648, 55.5648],
    'Venice': [45.4408, 12.3155], 'Naples': [40.8518, 14.2681], 'Palermo': [38.1157, 13.3615], 'Verona': [45.4384, 10.9945],
    'Turin': [45.0705, 7.6868], 'Bologna': [44.4949, 11.3426], 'Genoa': [44.4069, 8.9452], 'Pisa': [43.7228, 10.3964],
    'Siena': [43.3186, 11.9304], 'Assisi': [43.0605, 12.6130], 'Ravenna': [44.4176, 12.1957], 'Padua': [45.4064, 11.8768],
    'Bergamo': [45.6983, 9.6667], 'Como': [45.8100, 9.0833], 'Brescia': [45.5384, 10.2226], 'Modena': [44.6472, 10.9252],
    'Reggio Emilia': [44.7000, 10.6333], 'Parma': [44.8015, 10.3279], 'Cremona': [45.1306, 10.0215], 'Mantua': [45.1564, 10.7972],
    'Ancona': [43.6158, 13.5009], 'Perugia': [43.1122, 12.3909], 'Arezzo': [43.4641, 11.8796], 'Grosseto': [42.7653, 11.1187],
    'Livorno': [43.5481, 10.3072], 'Cagliari': [39.2238, 9.1216], 'Palermo': [38.1157, 13.3615], 'Messina': [38.1937, 15.5558],
    'Catania': [37.5079, 15.0873], 'Gela': [37.0267, 14.2458], 'Syracuse': [37.0754, 15.2842], 'Valletta': [35.8989, 14.5146],
    'Valletta': [35.8989, 14.5146], 'Antalya': [36.9124, 30.6956], 'Bodrum': [37.0381, 27.4259], 'Izmir': [38.4161, 27.1383],
    'Ankara': [39.9334, 32.8597], 'Bursa': [40.1955, 29.1668], 'Erzincan': [39.7500, 39.5000], 'Antalya': [36.9124, 30.6956],
    'Krakow': [50.0647, 19.9450], 'Gdansk': [54.3520, 18.6466], 'Poznan': [52.4064, 16.9252], 'Wroclaw': [51.1079, 17.0385],
    'Kalisz': [51.7592, 18.0833], 'Plock': [52.6167, 19.7000], 'Radom': [51.4024, 21.1458], 'Lublin': [51.2465, 22.5684],
    'Bialystok': [53.1312, 23.1688], 'Brest': [52.0988, 23.6879], 'Gdynia': [54.4882, 18.6300], 'Sopot': [54.4502, 18.5606],
    'Szczecin': [53.4286, 14.5528], 'Katowice': [50.2565, 19.0417], 'Zabrze': [50.3167, 18.7833], 'Tychy': [50.1250, 19.1500],
    'Gliwice': [50.2945, 18.6773], 'Bytom': [50.3483, 18.9213], 'Ruda Slaska': [50.2833, 18.8500], 'Dąbrowa Górnicza': [50.3385, 19.1869],
    'Chorzow': [50.2927, 18.9769], 'Bielsko-Biała': [49.8225, 18.8917], 'Czestochowa': [50.8144, 19.1200], 'Radomsko': [51.0833, 19.4333],
    'Belchatow': [51.3667, 19.3833], 'Konin': [52.2167, 18.2500], 'Turek': [51.7833, 18.6667], 'Sieradz': [51.6, 19.55],
    'Lodz': [51.7592, 19.4504]
};
...
class PinMapApp {
    ...
    geocodeLocation(state, city, country, foreignCity, callback) {
        ...
        // Foreign city coordinates (world cities - case insensitive lookup)
        const foreignCityCoords = {
            // Europe
        ...
        if (country === 'US') {
            ...
            coord = coords[key] || [39.8283, -98.5795]; // Default to US center
        } else {
            // For foreign cities, look up from the foreign city coordinates (case-insensitive)
            const cityKey = Object.keys(foreignCityCoords).find(
                key => key.toLowerCase() === foreignCity.toLowerCase()
            );
            coord = cityKey ? foreignCityCoords[cityKey] : [20, 0]; // Default to equator if not found
        }
