...
class PinMapApp {
    ...
    geocodeLocation(state, city, country, foreignCity, callback) {
        ...
        // Foreign city coordinates (major world cities)
        ...
        if (country === 'US') {
            ...
            // For foreign cities, look up from the foreign city coordinates
            coord = foreignCityCoords[foreignCity] || [20, 0]; // Default to equator
        }
